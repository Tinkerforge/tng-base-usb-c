...
#define USB2517_PRD_STR \
	USB_UTF16_LE('T'), USB_UTF16_LE('N'), USB_UTF16_LE('G'), USB_UTF16_LE('-'), USB_UTF16_LE('B'), USB_UTF16_LE('a'), USB_UTF16_LE('s'), USB_UTF16_LE('e'), \
	USB_UTF16_LE('-'), USB_UTF16_LE('U'), USB_UTF16_LE('S'), USB_UTF16_LE('B'), USB_UTF16_LE('-'), USB_UTF16_LE('C'),
...
USB2517Memory usb2517_memory = {
	...
	.prd_str_len = 14,                  // Product String Length
